        ...
        <>
            <div className="flex justify-between items-center font-semibold">
                ...
                <div className="flex items-center gap-4">
                    <p className="bg-white text-black px-4 py-1 rounded-2xl hidden md:block cursor-pointer">
                        Upgrade to Premium
                    </p>
                    <p className="bg-black border-2 border-white text-white px-4 py-1 rounded-2xl cursor-pointer">
                        Install app
                    </p>
                    <p className="bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center">
                        N
                    </p>
                </div>
            </div>
